...
def overlay_transparent_video(original_video, overlay_video_path, color = (), position=("center", "top"), overlay_size=None):
    overlay_video = VideoFileClip(overlay_video_path)
    overlay_video = overlay_video.with_effects([vfx.MaskColor((255, 49, 49),threshold=50,stiffness=100)])
