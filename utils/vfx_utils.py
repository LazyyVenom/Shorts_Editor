...
def overlay_transparent_video(original_video, overlay_video_path, color = (0, 254, 0), position=("center", "top"), overlay_size=None, start=0):
    ...
    overlay_video = overlay_video.with_position(position).with_start(start)
